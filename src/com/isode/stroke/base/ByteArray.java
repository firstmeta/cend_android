...
public class ByteArray {
	...
	/*
	 * public ByteArray(char[] c, int n) { for (int i = 0; i < n; i++) {
	 * append(c[i]); } }
	 */
	...
	/*
	 * public void resize(size_t size) { return data_.resize(size); }
	 */
	/** Immutable add */
	...
	/** Immutable add */
	/*
	 * public ByteArray plus(ByteArray a, char b) { ByteArray x = new
	 * ByteArray(a.getData()); x.append(b); return x; }
	 */
	...
	public boolean equals(Object other) {
		return other instanceof ByteArray
				&& toString().equals(other.toString());
	}

	/*
	 * public char charAt(int i) { return data_.charAt(i); }
	 */

	/*
	 * public const_iterator begin() const { return data_.begin(); }
	 * 
	 * public const_iterator end() const { return data_.end(); }
	 */
	@Override
