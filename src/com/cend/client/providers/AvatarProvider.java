 ...
 */
package com.cend.client.providers;
...
public class AvatarProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri
			.parse("content://com.cend.client.providers.avatarprovider");
	...
	private static final String AUTHORITY = "com.cend.client.providers.avatarprovider";
	...
	public boolean onCreate() {
		...
		File dataPath = new File(cacheDir,
				"/Android/data/com.cend.client/cache/avatar");
		dataPath.mkdirs();
