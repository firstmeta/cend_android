 ...
 */
package com.cend.client.smack.pep;
...
/**
 * Little extension of {@link PubSubManager} which allows to add
 * {@link PEPListener}.
 * 
 */
public class PepSubManager extends PubSubManager {
	...
	/**
	 * Create a PepSubManager associated to the specified connection where the
	...
	/**
	 * Get a PepNode. This node is obtain without checking its existence as PEP
