...
import com.cend.client.smack.avatar.AvatarManager;
import com.cend.client.smack.avatar.AvatarMetadataExtension.Info;
import com.cend.client.utils.Status;

/**
 * This class implement a Roster adapter for BEEM.
 */
public class RosterAdapter extends com.cend.client.service.aidl.IRoster.Stub {
	 ...
	 */
	@Override
	public boolean addContact(String user, String name, String[] groups)
			throws RemoteException {
	 ...
	 * 
	 * @see
	 * com.cend.client.service.aidl.IRoster#getPresence(java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.cend.client.service.aidl.IRoster#addContactToGroup(java.lang
	 ...
	 * 
	 * @see
	 * com.cend.client.service.aidl.IRoster#removeContactFromGroup(java
