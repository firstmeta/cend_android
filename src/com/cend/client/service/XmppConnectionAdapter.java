...
import com.cend.client.service.aidl.IBeemConnectionListener;
import com.cend.client.service.aidl.IChatManager;
import com.cend.client.service.aidl.IRoster;
import com.cend.client.service.aidl.IXmppConnection;
import com.cend.client.BeemApplication;
import com.cend.client.BeemService;
import com.cend.client.smack.avatar.AvatarCache;
import com.cend.client.smack.avatar.AvatarListener;
import com.cend.client.smack.avatar.AvatarMetadataExtension;
import com.cend.client.smack.pep.PepSubManager;
import com.cend.client.smack.ping.PingExtension;
import com.cend.client.ui.ChangeStatus;
import com.cend.client.ui.Subscription;
...
public class XmppConnectionAdapter extends IXmppConnection.Stub {
	...
	private void updateNotification(int status, String text) {
		...
		mStatusNotification = new Notification(
				Status.getIconBarFromStatus(status), text,
	...
	private void initPEP() {
		...
		mPepManager = new PepSubManager(mAdaptee,
				StringUtils.parseBareAddress(mAdaptee.getUser()));
	...
	private class SubscribePacketListener implements PacketListener {
		...
		public void processPacket(Packet packet) {
			...
			NotificationCompat.Builder notif = new NotificationCompat.Builder(
					mService);
			String title = mService.getString(R.string.AcceptContactRequest,
					from);
			String text = mService.getString(R.string.AcceptContactRequestFrom,
					from);
			...
			PendingIntent notifIntent = PendingIntent.getActivity(mService, 0,
