...
import com.cend.client.otr.BeemOtrManager;
...
public class ChatAdapter extends IChat.Stub {
	 ...
	 */
	@Override
	public void sendMessage(com.cend.client.service.Message message)
			throws RemoteException {
		com.cend.client.service.Message encrypted = otrEncryptMessage(message);
		if (encrypted != null) {
	 ...
	 *            the message to send
	 */
	private void transferMessage(com.cend.client.service.Message message) {
	 ...
	 *            message to log
	 */
	private void logMessage(com.cend.client.service.Message message) {
	 ...
	 */
	private com.cend.client.service.Message otrEncryptMessage(
			com.cend.client.service.Message unencrypted) {
