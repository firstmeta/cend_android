...
/**
 * Use this builder to build a dialog which allows you to display otr
 * fingerprints.
 * 
 * @author nikita
 */
public class DisplayOtrFingerprint extends AlertDialog.Builder {
	...
	public DisplayOtrFingerprint(final Context context, final IChat chat) {
		...
		mChat = chat;
		try {
			setMessage(context.getString(R.string.chat_otr_verify_key,
					chat.getLocalOtrFingerprint(),
