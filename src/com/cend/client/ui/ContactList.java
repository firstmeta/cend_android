...
import com.cend.client.ui.dialogs.builders.ResendSubscription;
...
public class ContactList extends FragmentActivity {
	...
	public final boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_friends:
			startActivity(new Intent(ContactList.this, this.getClass()));
			return true;
		case R.id.menu_wallet:
			startActivity(new Intent(ContactList.this, Wallet.class));
			return true;
